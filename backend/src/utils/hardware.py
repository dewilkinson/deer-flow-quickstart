...
def get_system_hardware() -> dict:
    ...
    try:
        ...
        return {
            "gpus": gpus,
            "cpus": cpus,
            "ram_bytes": ram.get("TotalPhysicalMemory", 0)
        }
...
def get_recommended_config(hw: dict) -> dict:
    ...
    config = {
        ...
        "core": {
            ...
            "reason": "Stable high-fidelity cloud reasoning."
        },
        "research": {
            "platform": "google_aistudio",
            "model": "gemini-3-flash-preview",
            "reason": "Fast analysis path enabled by default."
        },
        "vision": {
            "platform": "google_aistudio",
            "model": "gemini-2.0-flash",
            "reason": "High-fidelity cloud OCR benchmark."
        }
    }
    ...
    if category == "Entry":
        ...
        config["core"] = {
            "platform": "ollama",
            "model": "gemma4:e4b",
            "reason": "Optimized 4B variant for CPU-bound local execution."
        }
        ...
        config["core"] = {
            "platform": "ollama",
            "model": "gemma4:31b",
            "reason": "Local 31B Dense model for high-fidelity private reasoning."
        }
