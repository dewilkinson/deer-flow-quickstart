...
def reconcile_trades(history: list[dict], allow_short: bool = False) -> dict:
    ...
    if not history:
        return {
            "velocity": 0, "buys": 0, "sells": 0,
            "total_closed_trades": 0, "winning_trades": 0, "losing_trades": 0,
            "win_rate_pct": 0, "net_realized_pnl": 0
        }
